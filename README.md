...
### 🎨 UI/UX Design
The dashboard layout and user experience were first prototyped in **Figma**.
![Template 1](./docs/design/Template1.png)
![Template 2](./docs/design/Template2.png)
![Template 3](./docs/design/Template3.png)
## 🏗️ Architecture
